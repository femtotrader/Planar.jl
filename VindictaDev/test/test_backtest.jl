using VindictaDev.Stubs
using Test
using .Vindicta.Engine.Simulations.Random
...
test_backtest() = begin
    @eval begin
        using VindictaDev.Vindicta.Engine: Engine as egn
        using .egn.Instruments: Cash
        Vindicta.@environment!
        using .Vindicta.Engine.Strategies: reset!
