using VindictaDev.Vindicta.Engine.Instruments.Derivatives: @d_str
using VindictaDev.Vindicta.Engine.TimeTicks: @dtr_str, @dt_str
...
test_funding() = begin
    @eval begin
        using .Vindicta.Engine.LiveMode.Watchers.Fetch
        using .Vindicta.Engine.TimeTicks
        using .Vindicta.Engine.Data
        using .Vindicta.Engine.Exchanges: getexchange!
        using .Vindicta.Engine.Misc
    end
