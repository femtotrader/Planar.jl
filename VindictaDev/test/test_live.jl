...
using VindictaDev.Vindicta.Engine.Lang: @lget!, @m_str
using Test
using VindictaDev.Vindicta.Engine.Exchanges: Exchanges as exs
using VindictaDev.Vindicta.Engine.Misc: MarginMode
...
function _live_load()
    @eval begin
        using VindictaDev
        try
            @eval VindictaDev.Vindicta.@environment!
        catch
        end
