using Test
using VindictaDev.Vindicta.Engine.Lang: @m_str
using VindictaDev.Vindicta.Engine.TimeTicks
using VindictaDev.Vindicta.Engine.Exchanges.Python
using VindictaDev.Vindicta.Engine.Simulations.Random
using VindictaDev.Vindicta.Engine.Instances: NoMarginInstance, MarginInstance
...
function test_orders2()
    @testset "orders" begin
        @eval begin
            using VindictaDev
            using VindictaDev.Vindicta
            VindictaDev.Vindicta.@environment!
            using VindictaDev.Vindicta.Engine.Simulations.Random
            using .Misc: roundfloat
            using .Vindicta.Engine.Instances: NoMarginInstance, MarginInstance
            using .Vindicta.Engine.Strategies: MarginStrategy, Strategy
            using .ect:
                committment,
                withfees,
                amount_with_fees,
