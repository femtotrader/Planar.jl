...
function test_coingecko()
    @eval begin
        using .Vindicta.Engine.LiveMode.Watchers.CoinGecko
        using .Vindicta.Engine.Instruments
        using .Vindicta.Engine.TimeTicks
        using .Vindicta.Engine.Misc.Lang
        ...
        # to avoid rate limit
        Vindicta.Engine.LiveMode.Watchers._closeall()
    end
